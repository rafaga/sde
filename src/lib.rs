...
impl SdeManager<'_> {
    ...
    pub fn get_universe(&self, univ:&mut Universe) -> Result<bool,Error>{
        ...
        for region in regions{
            ...
            univ.dicts.region_names.entry(region.name.to_lowercase().clone()).or_insert(region.id);
        ...
        for constel in constellations{
            ...
            univ.dicts.constellation_names.entry(constel.name.to_lowercase().clone()).or_insert(constel.id);
        ...
        for system in solar_systems{
            ...
            univ.dicts.constellation_names.entry(system.name.to_lowercase().clone()).or_insert(system.id);
